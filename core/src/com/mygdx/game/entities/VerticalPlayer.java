...
public class VerticalPlayer extends Entity
{
    ...
    public VerticalPlayer(Vector2 position, Vector2 velocity, ColorType colorType, float width, float height, float topBound, float bottomBound, int upKey, int downKey)
    {
